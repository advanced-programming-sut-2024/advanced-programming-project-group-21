...
public enum CommandersEnum {
    ...
    //Monsters
    BRINGER_OF_DEATH("bringer of death",13,FactionsEnum.MONSTERS,"the power of siege cards is doubled unless there is a close combat card in that row","file:src/main/resources/Images/CommandersDetailed/monsters_bringerOfDeath.jpg","file:src/main/resources/Images/CommandersNoText/monsters_eredin_Bringer_of_death.jpg"),
