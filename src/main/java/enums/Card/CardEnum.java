...
public enum CardEnum {
    ...
    // Scoiatael
    ELVEN_SKIRMISHER("Elven Skirmisher", 26, FactionsEnum.SCOIATAEL, CardType.RANGED_UNIT,2, CardAbility.MUSTER, false, "file:src/main/resources/Images/CardsDetailed/scoiatael_elven_skirmisher_2 (1).jpg", "file:", 3),
    LORVETH("Lorveth", 27, FactionsEnum.SCOIATAEL, CardType.RANGED_UNIT,10, CardAbility.NONE, true, "file:src/main/resources/Images/CardsDetailed/scoiatael_iorveth.jpg", "file:", 1),
    DOL_BLATHANNA("Dol Blathanna Archer", 28, FactionsEnum.SCOIATAEL, CardType.RANGED_UNIT,4, CardAbility.NONE, false, "file:src/main/resources/Images/CardsDetailed/scoiatael_dol_archer.jpg", "file:", 1),
    HAVEKAR_HEALER("Havekar Healer", 29, FactionsEnum.SCOIATAEL, CardType.RANGED_UNIT,0, CardAbility.MEDIC, false, "file:src/main/resources/Images/CardsDetailed/scoiatael_havekar_healer.jpg", "file:", 3),
    IDA("Ida Emean", 30, FactionsEnum.SCOIATAEL, CardType.RANGED_UNIT,6, CardAbility.NONE, false, "file:src/main/resources/Images/CardsDetailed/scoiatael_ida.jpg", "file:", 1),
    RIORDAIN("Riordain", 31, FactionsEnum.SCOIATAEL, CardType.RANGED_UNIT,1, CardAbility.NONE, false, "file:src/main/resources/Images/CardsDetailed/scoiatael_riordain.jpg", "file:", 1),
    TORUVIEL("Toruviel", 32, FactionsEnum.SCOIATAEL, CardType.RANGED_UNIT,2, CardAbility.NONE, false, "file:src/main/resources/Images/CardsDetailed/scoiatael_toruviel.jpg", "file:", 1),
    VERIHEDD_BRIGADE_RECRIUT("Verihedd Brigade Recruit", 33, FactionsEnum.SCOIATAEL, CardType.RANGED_UNIT,4, CardAbility.NONE, false, "file:src/main/resources/Images/CardsDetailed/scoiatael_vrihedd_Brigade_RECRUIT.jpg", "file:", 1),
    MILVA("Milva", 34, FactionsEnum.SCOIATAEL, CardType.RANGED_UNIT,10, CardAbility.MORALE_BOOST, false, "file:src/main/resources/Images/CardsDetailed/scoiatael_milva.jpg", "file:", 1),
    SEASENTHESSIS("Seasenthesiss", 35, FactionsEnum.SCOIATAEL, CardType.RANGED_UNIT,10, CardAbility.NONE, true, "file:src/main/resources/Images/CardsDetailed/scoiatael_saesenthessis.jpg", "file:", 1),
    EITHNE("Eithne", 36, FactionsEnum.SCOIATAEL, CardType.RANGED_UNIT,10, CardAbility.NONE, true, "file:src/main/resources/Images/CardsDetailed/scoiatael_eithne.jpg", "file:", 1),
    YAEVINN("Yaevinn", 37, FactionsEnum.SCOIATAEL, CardType.AGILE_UNIT,6, CardAbility.NONE, false, "file:src/main/resources/Images/CardsDetailed/scoiatael_yaevinn.jpg", "file:", 1),
    CIARAN_AEP("Ciaran aep Easnillen", 38, FactionsEnum.SCOIATAEL, CardType.AGILE_UNIT,3, CardAbility.NONE, false, "file:src/main/resources/Images/CardsDetailed/scoiatael_ciaran.jpg", "file:", 1),
    DOL_BLATHANNA_SCOUT("Dol Blathanna Scout", 39, FactionsEnum.SCOIATAEL, CardType.AGILE_UNIT,6, CardAbility.NONE, false, "file:src/main/resources/Images/CardsDetailed/scoiatael_dol_blathanna.jpg", "file:", 3),
    FILAVANDREL("Filavandrel", 40, FactionsEnum.SCOIATAEL, CardType.AGILE_UNIT,6, CardAbility.NONE, false, "file:src/main/resources/Images/CardsDetailed/scoiatael_filavandrel.jpg", "file:", 1),
    VERIHEDD_BRIGADE_VETERAN("Verihedd Brigade Veteran", 41, FactionsEnum.SCOIATAEL, CardType.AGILE_UNIT,5, CardAbility.NONE, false, "file:src/main/resources/Images/CardsDetailed/scoiatael_vrihedd_brigade_VETERAN.jpg", "file:", 2),
    BARCLAY("Barclay Els", 42, FactionsEnum.SCOIATAEL, CardType.AGILE_UNIT,6, CardAbility.NONE, false, "file:src/main/resources/Images/CardsDetailed/scoiatael_barclay.jpg", "file:", 1),
    DENNIS_CRANMER("Dennis Cranmer", 43, FactionsEnum.SCOIATAEL, CardType.CLOSED_COMBAT_UNIT,6, CardAbility.NONE, false, "file:src/main/resources/Images/CardsDetailed/scoiatael_dennis.jpg", "file:", 1),
    DWARVEN_SKIRMISHER("Dwarven Skirmisher", 44, FactionsEnum.SCOIATAEL, CardType.CLOSED_COMBAT_UNIT,3, CardAbility.MUSTER, false, "file:src/main/resources/Images/CardsDetailed/scoiatael_dwarven_skirmisher.jpg", "file:", 3),
    HAVEKAR_SMUGGLER("Havekar Smuggler", 45, FactionsEnum.SCOIATAEL, CardType.CLOSED_COMBAT_UNIT,5, CardAbility.MUSTER, false, "file:src/main/resources/Images/CardsDetailed/scoiatael_havekar_smuggler.jpg", "file:", 3),
    MAHAKAM_DEFENDER("Mahakam Defender", 46, FactionsEnum.SCOIATAEL, CardType.CLOSED_COMBAT_UNIT,5, CardAbility.NONE, false, "file:src/main/resources/Images/CardsDetailed/scoiatael_mahakam_defender.jpg", "file:", 5),
    ISENGRIM_FAOILT("Isengrim Faoiltiarna", 47, FactionsEnum.SCOIATAEL, CardType.CLOSED_COMBAT_UNIT,10, CardAbility.MORALE_BOOST, true, "file:src/main/resources/Images/CardsDetailed/scoiatael_isengrim.jpg", "file:", 1),
    SCHIRRU("Schirru", 48, FactionsEnum.SCOIATAEL, CardType.SIEGE_UNIT,8, CardAbility.SCORCH, false, "file:src/main/resources/Images/CardsDetailed/scoiatael_schirru.jpg", "file:", 1),
    // Northern Realms
