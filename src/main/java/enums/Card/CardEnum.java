...
public enum CardEnum {
    ...
    //NEUTRAL
    BITING_FROST("Biting Frost",138,FactionsEnum.NEUTRAL,CardType.WEATHER,0,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/weather_frost.jpg","file:",3),
    IMPENETRABLE_FOG("Impenetrable Fog",139,FactionsEnum.NEUTRAL,CardType.WEATHER,0,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/weather_fog.jpg","file:",3),
    TORRENTIAL_RAIN("Torrential Rain",140,FactionsEnum.NEUTRAL,CardType.WEATHER,0,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/weather_rain.jpg","file:",3),
    SKELLIGE_STORM("Skellige Storm",141,FactionsEnum.NEUTRAL,CardType.WEATHER,0,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/weather_storm.jpg","file:",3),
    CLEAR_WEATHER("Clear Weather",142,FactionsEnum.NEUTRAL,CardType.WEATHER,0,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/weather_clear.jpg","file:",3),
    SCORCH("Scorch",143,FactionsEnum.NEUTRAL,CardType.SPELL,0,CardAbility.SCORCH,false,"file:src/main/resources/Images/CardsDetailed/special_scorch.jpg","file:",3),
    DECOY("Decoy",144,FactionsEnum.NEUTRAL,CardType.SPELL,0,CardAbility.DECOY,false,"file:src/main/resources/Images/CardsDetailed/special_decoy.jpg","file:",3),
    COMMANDERS_HORN("Commander's Horn",145,FactionsEnum.NEUTRAL,CardType.SPELL,0,CardAbility.COMMANDERS_HORN,false,"file:src/main/resources/Images/CardsDetailed/special_horn.jpg","file:",3),
    DANDELION("Dandelion",146,FactionsEnum.NEUTRAL,CardType.CLOSED_COMBAT_UNIT,2,CardAbility.COMMANDERS_HORN,false,"file:src/main/resources/Images/CardsDetailed/neutral_dandelion.jpg","file:",1),
    EMIEL_REGIS("Emiel Regis Rohellec Terzieff",147,FactionsEnum.NEUTRAL,CardType.CLOSED_COMBAT_UNIT,5,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/neutral_emiel.jpg","file:",1),
    GERALT_OF_RIVIA("Geralt of Rivia",148,FactionsEnum.NEUTRAL,CardType.CLOSED_COMBAT_UNIT,15,CardAbility.NONE,true,"file:src/main/resources/Images/CardsDetailed/neutral_geralt.jpg","file:",1),
    MYSTERIOUS_ELF("Mysterious Elf",149,FactionsEnum.NEUTRAL,CardType.CLOSED_COMBAT_UNIT,0,CardAbility.SPY,true,"file:src/main/resources/Images/CardsDetailed/neutral_mysterious_elf.jpg","file:",1),
    TRISS_MERIGOLD("Triss Merigold",150,FactionsEnum.NEUTRAL,CardType.CLOSED_COMBAT_UNIT,7,CardAbility.NONE,true,"file:src/main/resources/Images/CardsDetailed/neutral_triss.jpg","file:",1),
    VESEMIR("Vesemir",151,FactionsEnum.NEUTRAL,CardType.CLOSED_COMBAT_UNIT,6,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/neutral_vesemir.jpg","file:",1),
    VILLEN_TRETTMIR("Villentretenmerth",152,FactionsEnum.NEUTRAL,CardType.CLOSED_COMBAT_UNIT,7,CardAbility.SCORCH,false,"file:src/main/resources/Images/CardsDetailed/neutral_villen.jpg","file:",1),
    ZOLTAN_CHIVAY("Zoltan Chivay",153,FactionsEnum.NEUTRAL,CardType.CLOSED_COMBAT_UNIT,5,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/neutral_zoltan.jpg","file:",1),
    COW("Cow",154,FactionsEnum.NEUTRAL,CardType.RANGED_UNIT,0,CardAbility.TRANSFORMERMS,false,"file:src/main/resources/Images/CardsDetailed/neutral_cow.jpg","file:",1),
    GAUNTER_ODIMM_DARKNESS("Gaunter O'Dimm: Darkness",155,FactionsEnum.NEUTRAL,CardType.RANGED_UNIT,4,CardAbility.MUSTER,false,"file:src/main/resources/Images/CardsDetailed/neutral_gaunter_odimm_darkness.jpg","file:",3),
    YENNEFER_OF_VENGERBERG("Yennefer of Vengerberg",156,FactionsEnum.NEUTRAL,CardType.RANGED_UNIT,7,CardAbility.MEDIC,true,"file:src/main/resources/Images/CardsDetailed/neutral_yennefer.jpg","file:",1),
    GAUNTER_ODIMM("Gaunter O'Dimm",157,FactionsEnum.NEUTRAL,CardType.SIEGE_UNIT,2,CardAbility.MUSTER,false,"file:src/main/resources/Images/CardsDetailed/neutral_gaunter_odimm.jpg","file:",1),
    OLGIERD_VON_EVEREC("Olgierd von Everec",158,FactionsEnum.NEUTRAL,CardType.AGILE_UNIT,6,CardAbility.MORALE_BOOST,false,"file:src/main/resources/Images/CardsDetailed/neutral_olgierd.jpg","file:",1);
