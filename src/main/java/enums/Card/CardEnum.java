...
public enum CardEnum {
    ...
    VIDKAARL("Vidkaarl", 3, FactionsEnum.SKELLIGE, CardType.CLOSED_COMBAT_UNIT, 14, CardAbility.MORALE_BOOST,false, "file:src/main/resources/Images/CardsDetailed/skellige_vildkaarl.jpg", "file:src/main/resources/Images/CardsNoText/skellige_vildkaarl (1).jpg", 0),
    ...
    YOUNG_VIDKAARL("Young Vidkaarl", 20, FactionsEnum.SKELLIGE, CardType.RANGED_UNIT,8,CardAbility.TIGHT_BOND, false, "file:src/main/resources/Images/CardsDetailed/skellige_young_vildkaarl.jpg", "file:src/main/resources/Images/CardsNoText/skellige_young_vildkaarl (1).jpg", 0),
    ...
    // Monsters
    DRAUG("Draug",103,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,10,CardAbility.NONE,true,"file:src/main/resources/Images/CardsDetailed/monsters_draug.jpg","file:src/main/resources/Images/CardsNoText/monsters_draug.jpg",1),
    IMLERITH("Imlerith",104,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,10,CardAbility.NONE,true,"file:src/main/resources/Images/CardsDetailed/monsters_imlerith.jpg","file:src/main/resources/Images/CardsNoText/monsters_imlerith.jpg",1),
    LESHEN("Leshen",105,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,10,CardAbility.NONE,true,"file:","file:src/main/resources/Images/CardsNoText/monsters_leshen.jpg",1),
    CRONE_BREWESS("Crone: Brewess",106,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,6,CardAbility.MUSTER,false,"file:src/main/resources/Images/CardsDetailed/monsters_Brewess.jpg:","file:src/main/resources/Images/CardsNoText/monsters_witch_velen_1.jpg",1),
    CRONE_WEAVESS("Crone: Weavess",107,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,6,CardAbility.MUSTER,false,"file:src/main/resources/Images/CardsDetailed/monsters_weaves.jpg","file:src/main/resources/Images/CardsNoText/monsters_witch_velen_2.jpg",1),
    CRONE_WHISPESS("Crone: Whispess",108,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,6,CardAbility.MUSTER,false,"file:src/main/resources/Images/CardsDetailed/monsters_witch_velen_2.jpg","file:src/main/resources/Images/CardsNoText/monsters_witch_velen_2.jpg",1),
    FIEND("Fiend",109,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,6,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/monsters_fiend.jpg","file:src/main/resources/Images/CardsNoText/monsters_fiend.jpg",1),
    FORKTAIL("Forktail",110,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,5,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/monsters_forktail.jpg","file:src/main/resources/Images/CardsNoText/monsters_forktail.jpg",1),
    FRIGHTENER("Frightener",111,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,5,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/monsters_frightener.jpg","file:src/main/resources/Images/CardsNoText/monsters_frightener.jpg",1),
    GRIFFIN("Griffin",112,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,5,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/monsters_gryffin.jpg","file:src/main/resources/Images/CardsNoText/monsters_gryffin.jpg",1),
    PLAGUE_MAIDEN("Plague Maiden",113,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,5,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/monsters_mighty_maiden.jpg","file:src/main/resources/Images/CardsNoText/monsters_mighty_maiden.jpg",1),
    VAMPIRE_KATAKAN("Vampire: Katakan",114,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,5,CardAbility.MUSTER,false,"file:src/main/resources/Images/CardsDetailed/monsters_katakan.jpg","file:src/main/resources/Images/CardsNoText/monsters_katakan.jpg",1),
    WEREWOLF("Were-Wolf",115,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,5,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/monsters_werewolf.jpg","file:src/main/resources/Images/CardsNoText/monsters_werewolf.jpg",1),
    ARACHAS("Arachas",116,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,4,CardAbility.MUSTER,false,"file:src/main/resources/Images/CardsDetailed/monsters_arachas.jpg","file:src/main/resources/Images/CardsNoText/monsters_arachas.jpg",3),
    BOTCHLING("Botchling",117,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,4,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/monsters_botchling.jpg","file:src/main/resources/Images/CardsNoText/monsters_poroniec.jpg",1),
    VAMPIRE_BRUXA("Vampire: Bruxa",118,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,4,CardAbility.MUSTER,false,"file:src/main/resources/Images/CardsDetailed/monsters_bruxa.jpg","file:src/main/resources/Images/CardsNoText/monsters_bruxa.jpg",1),
    VAMPIRE_EKIMMARA("Vampire: Ekimmara",119,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,4,CardAbility.MUSTER,false,"file:src/main/resources/Images/CardsDetailed/monsters_ekkima.jpg","file:src/main/resources/Images/CardsNoText/monsters_ekkima.jpg",1),
    VAMPIRE_FLEDER("Vampire: Fleder",120,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,4,CardAbility.MUSTER,false,"file:src/main/resources/Images/CardsDetailed/monsters_fleder.jpg","file:src/main/resources/Images/CardsNoText/monsters_fleder.jpg",1),
    VAMPIRE_GARKAIN("Vampire: Garkain",121,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,4,CardAbility.MUSTER,false,"file:src/main/resources/Images/CardsDetailed/monsters_garkain.jpg","file:src/main/resources/Images/CardsNoText/monsters_garkain.jpg",1),
    FOGLET("Foglet",122,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,2,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/monsters_fogling.jpg","file:src/main/resources/Images/CardsNoText/monsters_fogling.jpg",1),
    NEKKER("Nekker",123,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,2,CardAbility.MUSTER,false,"file:src/main/resources/Images/CardsDetailed/monsters_nekker.jpg","file:src/main/resources/Images/CardsNoText/monsters_nekker.jpg",3),
    GHOUL("Ghoul",124,FactionsEnum.MONSTERS,CardType.CLOSED_COMBAT_UNIT,1,CardAbility.MUSTER,false,"file:src/main/resources/Images/CardsDetailed/monsters_ghoul.jpg","file:src/main/resources/Images/CardsNoText/monsters_ghoul.jpg",3),
    TOAD("Toad",125,FactionsEnum.MONSTERS,CardType.RANGED_UNIT,7,CardAbility.SCORCH,false,"file:src/main/resources/Images/CardsDetailed/monsters_toad.jpg","file:src/main/resources/Images/CardsNoText/monsters_toad.jpg",1),
    GRAVE_HAG("Grave Hag",126,FactionsEnum.MONSTERS,CardType.RANGED_UNIT,5,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/monsters_gravehag.jpg","file:src/main/resources/Images/CardsNoText/monsters_gravehag.jpg",1),
    COCKATRICE("Cockatrice",127,FactionsEnum.MONSTERS,CardType.RANGED_UNIT,2,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/monsters_cockatrice.jpg","file:src/main/resources/Images/CardsNoText/monsters_cockatrice.jpg",1),
    ENDREGA("Endrega",128,FactionsEnum.MONSTERS,CardType.RANGED_UNIT,2,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/monsters_endrega.jpg","file:src/main/resources/Images/CardsNoText/monsters_endrega.jpg",1),
    GARGOYLE("Gargoyle",129,FactionsEnum.MONSTERS,CardType.RANGED_UNIT,2,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/monsters_gargoyle.jpg","file:src/main/resources/Images/CardsNoText/monsters_gargoyle.jpg",1),
    WYVERN("Wyvern",130,FactionsEnum.MONSTERS,CardType.RANGED_UNIT,2,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/monsters_wyvern.jpg","file:src/main/resources/Images/CardsNoText/monsters_wyvern.jpg",1),
    KAYRAN("Kayran",131,FactionsEnum.MONSTERS,CardType.AGILE_UNIT,8,CardAbility.MORALE_BOOST,true,"file:src/main/resources/Images/CardsDetailed/monsters_kayran.jpg","file:src/main/resources/Images/CardsNoText/monsters_kayran.jpg",1),
    CELAENO_HARPY("Celaeno Harpy",132,FactionsEnum.MONSTERS,CardType.AGILE_UNIT,2,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/monsters_celaeno_harpy.jpg","file:src/main/resources/Images/CardsNoText/monsters_celaeno_harpy.jpg",1),
    HARPY("Harpy",133,FactionsEnum.MONSTERS,CardType.AGILE_UNIT,2,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/monsters_harpy.jpg","file:src/main/resources/Images/CardsNoText/monsters_harpy.jpg",1),
    ARACHAS_BEHEMOTH("Arachas Behemoth",134,FactionsEnum.MONSTERS,CardType.SIEGE_UNIT,6,CardAbility.MUSTER,false,"file:src/main/resources/Images/CardsDetailed/monsters_arachas_behemoth.jpg","file:src/main/resources/Images/CardsNoText/monsters_arachas.jpg",1),
    EARTH_ELEMENTAL("Earth Elemental",135,FactionsEnum.MONSTERS,CardType.SIEGE_UNIT,6,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/monsters_earth_elemental.jpg","file:src/main/resources/Images/CardsNoText/monsters_earth_elemental.jpg",1),
    FIRE_ELEMENTAL("Fire Elemental",136,FactionsEnum.MONSTERS,CardType.SIEGE_UNIT,6,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/monsters_fire_elemental.jpg","file:src/main/resources/Images/CardsNoText/monsters_fire_elemental.jpg",1),
    ICE_GIANT("Ice Giant",137,FactionsEnum.MONSTERS,CardType.SIEGE_UNIT,5,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/monsters_frost_giant.jpg","file:src/main/resources/Images/CardsNoText/monsters_frost_giant.jpg",1),
    //NEUTRAL
    BITING_FROST("Biting Frost",138,FactionsEnum.NEUTRAL,CardType.WEATHER,0,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/weather_frost.jpg","file:src/main/resources/Images/CardsNoText/weather_frost.jpg",3),
    IMPENETRABLE_FOG("Impenetrable Fog",139,FactionsEnum.NEUTRAL,CardType.WEATHER,0,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/weather_fog.jpg","file:src/main/resources/Images/CardsNoText/weather_fog.jpg",3),
    TORRENTIAL_RAIN("Torrential Rain",140,FactionsEnum.NEUTRAL,CardType.WEATHER,0,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/weather_rain.jpg","file:src/main/resources/Images/CardsNoText/weather_rain.jpg",3),
    SKELLIGE_STORM("Skellige Storm",141,FactionsEnum.NEUTRAL,CardType.WEATHER,0,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/weather_storm.jpg","file:src/main/resources/Images/CardsNoText/weather_storm.jpg",3),
    CLEAR_WEATHER("Clear Weather",142,FactionsEnum.NEUTRAL,CardType.WEATHER,0,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/weather_clear.jpg","file:src/main/resources/Images/CardsNoText/weather_clear.jpg",3),
    SCORCH("Scorch",143,FactionsEnum.NEUTRAL,CardType.SPELL,0,CardAbility.SCORCH,false,"file:src/main/resources/Images/CardsDetailed/special_scorch.jpg","file:src/main/resources/Images/CardsNoText/special_scorch.jpg",3),
    DECOY("Decoy",144,FactionsEnum.NEUTRAL,CardType.SPELL,0,CardAbility.DECOY,false,"file:src/main/resources/Images/CardsDetailed/special_decoy.jpg","file:src/main/resources/Images/CardsNoText/special_decoy.jpg",3),
    COMMANDERS_HORN("Commander's Horn",145,FactionsEnum.NEUTRAL,CardType.SPELL,0,CardAbility.COMMANDERS_HORN,false,"file:src/main/resources/Images/CardsDetailed/special_horn.jpg","file:src/main/resources/Images/CardsNoText/special_horn.jpg",3),
    DANDELION("Dandelion",146,FactionsEnum.NEUTRAL,CardType.CLOSED_COMBAT_UNIT,2,CardAbility.COMMANDERS_HORN,false,"file:src/main/resources/Images/CardsDetailed/neutral_dandelion.jpg","file:src/main/resources/Images/CardsNoText/neutral_dandelion.jpg",1),
    EMIEL_REGIS("Emiel Regis Rohellec Terzieff",147,FactionsEnum.NEUTRAL,CardType.CLOSED_COMBAT_UNIT,5,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/neutral_emiel.jpg","file:src/main/resources/Images/CardsNoText/neutral_emiel.jpg",1),
    GERALT_OF_RIVIA("Geralt of Rivia",148,FactionsEnum.NEUTRAL,CardType.CLOSED_COMBAT_UNIT,15,CardAbility.NONE,true,"file:src/main/resources/Images/CardsDetailed/neutral_geralt.jpg","file:src/main/resources/Images/CardsNoText/neutral_geralt.jpg",1),
    MYSTERIOUS_ELF("Mysterious Elf",149,FactionsEnum.NEUTRAL,CardType.CLOSED_COMBAT_UNIT,0,CardAbility.SPY,true,"file:src/main/resources/Images/CardsDetailed/neutral_mysterious_elf.jpg","file:src/main/resources/Images/CardsNoText/neutral_mysterious_elf.jpg",1),
    TRISS_MERIGOLD("Triss Merigold",150,FactionsEnum.NEUTRAL,CardType.CLOSED_COMBAT_UNIT,7,CardAbility.NONE,true,"file:src/main/resources/Images/CardsDetailed/neutral_triss.jpg","file:src/main/resources/Images/CardsNoText/neutral_triss.jpg",1),
    VESEMIR("Vesemir",151,FactionsEnum.NEUTRAL,CardType.CLOSED_COMBAT_UNIT,6,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/neutral_vesemir.jpg","file:src/main/resources/Images/CardsNoText/neutral_vesemir.jpg",1),
    VILLEN_TRETTMIR("Villentretenmerth",152,FactionsEnum.NEUTRAL,CardType.CLOSED_COMBAT_UNIT,7,CardAbility.SCORCH,false,"file:src/main/resources/Images/CardsDetailed/neutral_villen.jpg","file:src/main/resources/Images/CardsNoText/neutral_villen.jpg",1),
    ZOLTAN_CHIVAY("Zoltan Chivay",153,FactionsEnum.NEUTRAL,CardType.CLOSED_COMBAT_UNIT,5,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/neutral_zoltan.jpg","file:src/main/resources/Images/CardsNoText/neutral_zoltan.jpg",1),
    COW("Cow",154,FactionsEnum.NEUTRAL,CardType.RANGED_UNIT,0,CardAbility.TRANSFORMERMS,false,"file:src/main/resources/Images/CardsDetailed/neutral_cow.jpg","file:src/main/resources/Images/CardsNoText/neutral_cow.jpg",1),
    GAUNTER_ODIMM_DARKNESS("Gaunter O'Dimm: Darkness",155,FactionsEnum.NEUTRAL,CardType.RANGED_UNIT,4,CardAbility.MUSTER,false,"file:src/main/resources/Images/CardsDetailed/neutral_gaunter_odimm_darkness.jpg","file:src/main/resources/Images/CardsNoText/neutral_gaunter_odimm_darkness.jpg",3),
    YENNEFER_OF_VENGERBERG("Yennefer of Vengerberg",156,FactionsEnum.NEUTRAL,CardType.RANGED_UNIT,7,CardAbility.MEDIC,true,"file:src/main/resources/Images/CardsDetailed/neutral_yennefer.jpg","file:src/main/resources/Images/CardsNoText/neutral_yennefer.jpg",1),
    GAUNTER_ODIMM("Gaunter O'Dimm",157,FactionsEnum.NEUTRAL,CardType.SIEGE_UNIT,2,CardAbility.MUSTER,false,"file:src/main/resources/Images/CardsDetailed/neutral_gaunter_odimm.jpg","file:src/main/resources/Images/CardsNoText/neutral_gaunter_odimm.jpg",1),
    OLGIERD_VON_EVEREC("Olgierd von Everec",158,FactionsEnum.NEUTRAL,CardType.AGILE_UNIT,6,CardAbility.MORALE_BOOST,false,"file:src/main/resources/Images/CardsDetailed/neutral_olgierd.jpg","file:src/main/resources/Images/CardsNoText/neutral_olgierd.jpg",1);
