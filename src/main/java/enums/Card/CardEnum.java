...
public enum CardEnum {
    ...
    // nilfgaard
    IMPERA_BRIGADE_GUARD("Impera Brigade Guard",74,FactionsEnum.NILFGAARD,CardType.CLOSED_COMBAT_UNIT,3,CardAbility.TIGHT_BOND,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_imperal_brigade.jpg","file:",4),
    STEFAN("Stefan Skellen",75,FactionsEnum.NILFGAARD,CardType.CLOSED_COMBAT_UNIT,9,CardAbility.SPY,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_stefan.jpg","file:",1),
    SHILARD("Shilard Fitz-Oesterlen",76,FactionsEnum.NILFGAARD,CardType.CLOSED_COMBAT_UNIT,7,CardAbility.SPY,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_shilard.jpg","file:",1),
    YOUNG_EMISSARY("Young Emissary",77,FactionsEnum.NILFGAARD,CardType.CLOSED_COMBAT_UNIT,5,CardAbility.TIGHT_BOND,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_young_emissary.jpg","file:",2),
    CAHIR_MAWR("Cahir Mawr Dyffryn aep Ceallach",78,FactionsEnum.NILFGAARD,CardType.CLOSED_COMBAT_UNIT,6,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_cahir.jpg","file:",1),
    VATTIER("Vattier de Rideaux",79,FactionsEnum.NILFGAARD,CardType.CLOSED_COMBAT_UNIT,4,CardAbility.SPY,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_vattier.jpg","file:",1),
    MENNO("Menno Coehoorn",80,FactionsEnum.NILFGAARD,CardType.CLOSED_COMBAT_UNIT,10,CardAbility.MEDIC,true,"file:src/main/resources/Images/CardsDetailed/nilfgaard_menno.jpg","file:",1),
    LETHO_OF_GULET("Letho of Gulet",81,FactionsEnum.NILFGAARD,CardType.CLOSED_COMBAT_UNIT,10,CardAbility.NONE,true,"file:src/main/resources/Images/CardsDetailed/nilfgaard_letho.jpg","file:",1),
    MORTEISEN("Morteisen",82,FactionsEnum.NILFGAARD,CardType.CLOSED_COMBAT_UNIT,3,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_morteisen.jpg","file:",1),
    NAUSICAA("Nausicaa Cavalry Rider",83,FactionsEnum.NILFGAARD,CardType.CLOSED_COMBAT_UNIT,2,CardAbility.TIGHT_BOND,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_nauzicaa_2.jpg","file:",3),
    RAINFAARN("Rainfarn",84,FactionsEnum.NILFGAARD,CardType.CLOSED_COMBAT_UNIT,4,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_rainfarn.jpg","file:",1),
    VREEMDE("Vreemde",85,FactionsEnum.NILFGAARD,CardType.CLOSED_COMBAT_UNIT,2,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_vreemde.jpg","file:",1),
    PUTTKAMER("Puttkamer",86,FactionsEnum.NILFGAARD,CardType.RANGED_UNIT,3,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_puttkammer.jpg","file:",1),
    ASSIRE_VAR_ANAHID("Assire var Anahid",87,FactionsEnum.NILFGAARD,CardType.RANGED_UNIT,6,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_assire.jpg","file:",1),
    BLACK_INFANTRY_ARCHER("Black Infantry Archer",88,FactionsEnum.NILFGAARD,CardType.RANGED_UNIT,10,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_black_archer.jpg","file:",2),
    TIBOR_EGGEBRACHT("Tibor Eggebracht",89,FactionsEnum.NILFGAARD,CardType.RANGED_UNIT,10,CardAbility.NONE,true,"file:src/main/resources/Images/CardsDetailed/nilfgaard_tibor.jpg","file:",1),
    RENUALD_AEP_MATSEN("Renuald aep Matsen",90,FactionsEnum.NILFGAARD,CardType.RANGED_UNIT,5,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_renuald.jpg","file:",1),
    FRINGILLA("Fringilla Vigo",91,FactionsEnum.NILFGAARD,CardType.RANGED_UNIT,6,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_fringilla.jpg","file:",1),
    ALBRICH("Albrich",92,FactionsEnum.NILFGAARD,CardType.RANGED_UNIT,2,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_albrich.jpg","file:",1),
    CYNTHIA("Cynthia",93,FactionsEnum.NILFGAARD,CardType.RANGED_UNIT,4,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_cynthia.jpg","file:",1),
    ETOLIAN_AUXILIARY("Etolian Auxiliary Archer",94,FactionsEnum.NILFGAARD,CardType.RANGED_UNIT,1,CardAbility.MEDIC,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_etolian.jpg","file:",2),
    SWEERS("Sweers",95,FactionsEnum.NILFGAARD,CardType.RANGED_UNIT,2,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_sweers.jpg","file:",1),
    VANHEMAR("Vanhemar",96,FactionsEnum.NILFGAARD,CardType.RANGED_UNIT,4,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_vanhemar.jpg","file:",1),
    ROTTEN_MANGONEL("Rotten Mangonel",97,FactionsEnum.NILFGAARD,CardType.SIEGE_UNIT,3,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_rotten.jpg","file:",1),
    HEAVY_ZERKANIAN_FIRE_SCORPION("Heavy Zerkanian Fire Scorpion",98,FactionsEnum.NILFGAARD,CardType.SIEGE_UNIT,10,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_heavy_zerri.jpg","file:",1),
    ZERRIKANIAN_FIRE_SCORPION("Zerrikanian Fire Scorpion",99,FactionsEnum.NILFGAARD,CardType.SIEGE_UNIT,5,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_zerri.jpg","file:",1),
    SIEGE_ENGINEER("Siege Engineer",100,FactionsEnum.NILFGAARD,CardType.SIEGE_UNIT,6,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_siege_engineer.jpg","file:",1),
    MORVARN("Morvran Voorhis",101,FactionsEnum.NILFGAARD,CardType.SIEGE_UNIT,10,CardAbility.NONE,true,"file:src/main/resources/Images/CardsDetailed/nilfgaard_moorvran.jpg","file:",1),
    SIEGE_TECHNICIAN("Siege Technician",102,FactionsEnum.NILFGAARD,CardType.SIEGE_UNIT,0,CardAbility.NONE,false,"file:src/main/resources/Images/CardsDetailed/nilfgaard_siege_tech.jpg","file:",1),
    // Monsters
